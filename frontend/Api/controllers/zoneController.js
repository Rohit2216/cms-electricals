...
const createZone = async(req, res) => {
    ...
    try 
    {
        ...
        db.query(insertQuery, async(err, result) => {
            ...
            {
                const getInsertedZoneId = result.insertId
                const zoneAssigns = `INSERT INTO zone_assigns(zone_id, energy_company_id) VALUES(?, ?)`
                const queryResult = await db.query(zoneAssigns, [getInsertedZoneId, energy_company_id])
...
const getAllZones = async(req, res) => {
    ...
    try 
    {
        ...
        const countSelectQuery = `SELECT COUNT(*) as total FROM zones`
