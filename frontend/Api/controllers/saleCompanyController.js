...
const getSaleCompanies = async (req, res) => {
    ...
    try 
    {
        ...
        constTotalLength = await db.query(countSelectQuery, [process.env.SALE_COMPANY, process.env.INACTIVE_STATUS]);
        ...
        queryParams.unshift(process.env.VALUE_ZERO, process.env.SALE_COMPANY, process.env.INACTIVE_STATUS);
