...
const { calculatePagination, getUserDetails, getCreatedByDetails, generateRandomAlphanumerics, updateOrNotFund, generateRandomNumber } = require('../helpers/general');
...
const getAllApprovedFundRequests = async (req, res) => {
    ...
    try {
        ...
        const selectQuery = `SELECT new_fund_requests.* FROM new_fund_requests WHERE status = '1' ${search_value} ORDER BY new_fund_requests.id ASC LIMIT ${pageFirstResult} , ${pageSize}`
...
const getAllRejectedFundRequests = async (req, res) => {
    ...
    try {
        ...
        const selectQuery = `SELECT new_fund_requests.* FROM new_fund_requests WHERE status = '2' ${search_value} ORDER BY new_fund_requests.id ASC LIMIT ${pageFirstResult} , ${pageSize}`
