...
const contractorCreate = async (req, res) => {
    ...
    try 
    {     
        const {name, email, password, contact_no, alt_number, address_1, country, city, pin_code, description, gst_number, pan_number, status, plan_id} = req.body
        ...
        const insertQuery = `INSERT INTO admins (name, email, password, contact_no, alt_number, user_type, address_1, country, city, pin_code, image, description, gst_number, pan_number, status, created_by, panel_id, plan_id , plan_expire_date) VALUES('${name}', '${email}', '${hashPassword}', '${contact_no}', '${alt_number}', '${user_type}', '${address_1}', '${country}', '${pin_code}', '${city}', '${storePath}', '${description}', '${gst_number}', '${ pan_number}', '${status}', '${created_by}', '${panel_id}', '${plan_id}', '${plan_expire_date}')`
