...
const getHolidayListOfMonth = async(req, res) => {
    ...
    try {
        ...
        const queryResult = await db.query(`SELECT id, holiday_name, holiday_date, holiday_type FROM holiday_lists WHERE DATE_FORMAT(holiday_date, '%Y-%m') = ?`, [yearMonth])
...
module.exports = {createHolidayList, getAllHolidayList, getHolidayDetailById, updateHolidayList, deleteHolidayList, getHolidayListOfMonth, getTodayBirthdayList}